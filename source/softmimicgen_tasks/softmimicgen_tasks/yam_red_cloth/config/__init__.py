...
gym.register(
    id="Isaac-Fold-Red-Cloth-Yam-Joint-v0",
    entry_point="softmimicgen.envs.soft_mimic_env:SoftManagerBasedRLMimicEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.joint_pos_env_cfg:YamRedClothEnvCfg",
...
gym.register(
    id="Isaac-Fold-Red-Cloth-Yam-Joint-DR-v0",
    entry_point="softmimicgen.envs.soft_mimic_env:SoftManagerBasedRLMimicEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.dr_env_cfg:YamRedClothDREnvCfg",
        "robomimic_bc_cfg_entry_point": os.path.join(agents.__path__[0], "robomimic/bc_rnn_image.json"),
        "robomimic_bc_crop224_cfg_entry_point": os.path.join(
            agents.__path__[0], "robomimic/bc_rnn_image_crop224.json"
        ),
...
gym.register(
    id="Isaac-Fold-Red-Cloth-Yam-Joint-Perception-v0",
    entry_point="softmimicgen.envs.soft_mimic_env:SoftManagerBasedRLMimicEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.perception_env_cfg:YamRedClothPerceptionEnvCfg",
        "robomimic_bc_cfg_entry_point": os.path.join(agents.__path__[0], "robomimic/bc_rnn_image.json"),
        "robomimic_bc_crop224_cfg_entry_point": os.path.join(
            agents.__path__[0], "robomimic/bc_rnn_image_crop224.json"
        ),
